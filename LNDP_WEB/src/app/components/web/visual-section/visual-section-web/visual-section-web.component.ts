...
@Component({
  selector: 'app-visual-section-web',
  templateUrl: './visual-section-web.component.html',
  styleUrls: ['./visual-section-web.component.scss']
})
export class VisualSectionWebComponent {
  title = "Visual"
