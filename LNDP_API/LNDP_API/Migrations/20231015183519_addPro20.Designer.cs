...
namespace LNDP_API.Migrations
{
    ...
    [Migration("20231015183519_addPro20")]
    partial class addPro20
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LNDP_API.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Email = "Sanchez",
                            PasswordHash = "ZaMvRVQMshgo/y8V3WUK/lfzkd5lzOWUzHW9ldf9saE=",
                            PasswordSalt = "T1L2rT2oBp4KzLSCKh3dtA==",
                            UserRoleId = 1,
                            Username = "Sanchez"
                        },
                        new
                        {
                            Id = 2,
                            Email = "Torres",
                            PasswordHash = "nrmwvylx5pgh1L//916wIsvyJqCfsLRoGQNFxfkMlIk=",
                            PasswordSalt = "T1L2rT2oBp4KzLSCKh3dtA==",
                            UserRoleId = 1,
                            Username = "Torres"
                        },
                        new
                        {
                            Id = 3,
                            Email = "Tomas",
                            PasswordHash = "wfkc1pOyPyOn4xcvdsBfHY9tXmRKP0PyquGNlHEI+Dw=",
                            PasswordSalt = "T1L2rT2oBp4KzLSCKh3dtA==",
                            UserRoleId = 1,
                            Username = "Tomas"
                        },
                        new
                        {
                            Id = 4,
                            Email = "Iglesias",
                            PasswordHash = "FffLekegpGOkuV4IVPYpRevLxuxTMSxUqgK+aHMIYI8=",
                            PasswordSalt = "T1L2rT2oBp4KzLSCKh3dtA==",
                            UserRoleId = 2,
                            Username = "Iglesias"
                        });
