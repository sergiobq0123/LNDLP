...
namespace LNDP_API.Migrations
{
    ...
    [Migration("20231015150649_addPro16")]
    partial class addPro16
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LNDP_API.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Email = "Sanchez",
                            PasswordHash = "RMhavNDpQUqoDKr2+WsYBY1+7AoVp6u1nO7gToXUkvU=",
                            PasswordSalt = "BUgd71PLdir0eNCk3ODN5g==",
                            UserRoleId = 1,
                            Username = "Sanchez"
                        },
                        new
                        {
                            Id = 2,
                            Email = "Torres",
                            PasswordHash = "4bR9jOOFV14pkozpiK2wo1US3SzSU3ew+bg2hiSqnZc=",
                            PasswordSalt = "BUgd71PLdir0eNCk3ODN5g==",
                            UserRoleId = 1,
                            Username = "Torres"
                        },
                        new
                        {
                            Id = 3,
                            Email = "Tomas",
                            PasswordHash = "StBmBFv2L1HjEzAzk/fVW369rOaWvvyxbtS83po2ceY=",
                            PasswordSalt = "BUgd71PLdir0eNCk3ODN5g==",
                            UserRoleId = 1,
                            Username = "Tomas"
                        },
                        new
                        {
                            Id = 4,
                            Email = "Iglesias",
                            PasswordHash = "2ttcBUZUDfHdAYPBPQ6Ky/hrf9pkNEzXYg5phTVZzBA=",
                            PasswordSalt = "BUgd71PLdir0eNCk3ODN5g==",
                            UserRoleId = 2,
                            Username = "Iglesias"
                        });
